    ...
    <div class="container mb-5">
        ...
        <div class="row mt-3">
            <div class="col-sm-12 text-black-50">
                <h1 class="h3 animated-hover" id="startups" animation="animate__jackInTheBox">resume.history (startups)</h1>
                <p>
        ...
        <div class="row mt-4">
            ...
            <div class="col-12 mt-2 font-weight-light">
                <a href="https://www.deedclaim.com" target="_blank">DeedClaim.com</a> and <a href="https://www.privatecounsel.com" target="_blank">PrivateCounsel.com</a> provides self service and attorney reviewed document automation for the evolving legal industry. The product involved thoughtful architecture, development and technical management for generating real estate, corporate formation and ancillary documents across a range a complex legal requirements in all 50 states.
            </div>
